...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
    ...
    $profile_sql = "UPDATE user SET f_name = '$f_name', l_name = '$l_name', email = '$email', phone_no = '$phone_no', address = '$address', store_name = '$store_name',image = '$image' WHERE id = '$dealer_id'";
